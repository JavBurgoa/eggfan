...
parser.add_argument("--rm_conversions", action = "store_true", help="Remove all gene ID conversions from the final output, keep only the IDs used in matched_column")
